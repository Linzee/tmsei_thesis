...
\begin{figure}
  ...
  \caption{``fill-in-the-blank'' example question; TODO Better descriptions quality and size of all figures}
...
\begin{figure}
  ...
  \caption{Basic t-SNE projection of one item-set; TODO Better descriptions quality and size of all figures}
