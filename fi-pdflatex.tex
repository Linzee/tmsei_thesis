...
A primary group of users using Umíme česky are children studying at primary and secondary school. Users can have individual accounts
...
Dataset from Umíme česky was used previously in few articles and thesis. Most of the work relevant to our problem comes from article Measuring Similarity of Educational Items Using Data on Learners’ Performance [CITE].
...
single word with added suffix. However there is no information about item statement presented to similarity measure.
...
When you look back at figure \ref{fig:common_projection} you can see that
...
We applied 4 different measures for computing similarity matrix to verify
that previous results aren't specific to single measure. Especially if it
