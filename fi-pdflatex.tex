...
There is a lot of research about similarity in many different fields like bioinformatics (sequence alignment, similarity matrix of proteins), data >>>processing/retrieval<<< (document similarity), plagiarism detection and many more. But only a few mentions about comparing programming problems are currently published. When we talk about programming problems we in most cases mean problems created for interactive programming environments for introductory programming. Some examples of environments are [Robotanik](https://tutor.fi.muni.cz/), []>>>robot z modeling how students learn to program<<<](http://example.com), [Lightbot]().
