...
% One cell in performance matrix, row and column in similarity and all in projection or second level of similarity
...
Figure \ref{fig:answers_normalization} shows difference in original projection and modified projection after removing part of users. Colors in this particular image represent correct answers of items. % TODO more new text here
