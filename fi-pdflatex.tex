...
\begin{markdown}
in many fields, but not this problem
- In bioinformatics, a sequence alignment is a way of arranging the sequences of DNA, RNA, or protein to identify regions of similarity Similarity Matrix of Proteins
- In data processing: Document Similarity
- Plagiarism
...
based on performance of students while solving problems (solution time, number of attempts, ...)
"correlation" based similarity (performance on two problems correlates)

\subsection{Solution syntax}

simple text features (presence of keywords, count)

analysis of solution abstract syntax tree (AST)
	tree edit distance
...
for standar text problems...
text of problem statement (natual language keywords used)
input/output specification

for interactive rpogramming enviroemnts..
"features" used in problem - tiles on game board
