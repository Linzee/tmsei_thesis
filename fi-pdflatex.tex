...
Another possible visualisations include ??? %TODOco sa momentalne zobrazujeav ucitelskom mode (na slepych ampach)

% clustering of similarity

note that it may be as well as projection affected by both possible levels of high-level features... second level is caused by implicit (euclidean) distance in clustering algorithms %TODOnot mentioned yet
