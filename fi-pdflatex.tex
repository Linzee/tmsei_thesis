...
User answer performance is calculated as ratio of items which user answered correctly to all items when looking only at items with particular correct answer. We calculate this value for each possible answer and each user. Then we combine this set of values for each user to one using their variation. This gives us single value representing whether user uses some answer by default. %TODO range 0.0 - 0.5 HERE
