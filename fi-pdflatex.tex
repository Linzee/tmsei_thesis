...
When exploring data, it may be useful to detect outsiders. There are multiple reasons for doing so ... [CITE]. In our particular case, we declare item an outsider when it is not similar to any other items in item-set. seems like a logical path to take.
